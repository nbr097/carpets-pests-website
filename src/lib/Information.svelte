<section
	...
	class="mt-24 md:mt-28 lg:mt-8 max-w-7xl pl-8 pr-8 select-none mx-auto"
>
	<div class="container font-medium pb-8 mx-auto" id="about">
		<div class="grid overflow-hidden grid-cols-1 lg:grid-cols-6 lg:grid-rows-3 lg:gap-4 mt-7">
